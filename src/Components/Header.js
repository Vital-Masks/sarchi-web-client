...
function Header() {
  ...
  <small className="ms-4">
    <a href="mailto:info@satchiuk.com" style={{color: '#464646'}}>
      ...
      <div
        className="header-2 sticky-top"
        style={{ background: '#111727', fontSize: '25px' }}
      >
        <div className="container py-4">
          <nav className="navbar navbar-expand-lg navbar-light p-lg-0">
            ...
            <div className="collapse navbar-collapse" id="navbarCollapse">
              ...
              <div className="ms-auto d-none d-lg-block">
                <a
                  href="/post"
                  className="rounded-pill py-2 px-3 text-white"
                  style={{ background: '#111727', border: '2px solid white' }}
                >
                  Post a Job
                </a>
              </div>
