...
function Vacancies() {
  ...
  return (
    <>
      ...
      <div className="container search-container-header py-3 mb-5" style={{borderRadius:'25px'}}>
        <form>
                  ...
                  <div className="box mt-4">
                     ...
                     <div className="col-lg-12">
                           ...
                           <div className="d-flex flex-wrap mb-2">
                              ...
                              <p className="search rounded-pill text-black mr-2 mb-2 py-1" style={{marginLeft:'10px',fontSize:'15px',marginTop:'05px',background:'#f098ff',width:'100px',textAlign:'center'}}>{item.attributes.Experience_Levels}</p>
                              <p className="search rounded-pill text-black mr-2 mb-2 py-1" style={{marginLeft:'10px',fontSize:'15px',marginTop:'05px',background:'#67b6ff',width:'100px',textAlign:'center'}}>{item.attributes.Type_Of_Jobs}</p>
                         </div>
