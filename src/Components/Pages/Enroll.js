...
function Enroll() {
  ...
  const handleSubmit = async (e) => {
    ...
    formData.forEach((value, key) => { 
        ...
        if (['Own_Transport', 'Driving_License', 'Free_to_Takeup_Employment', 'Crimincal_Conviction', 'Health_Issue', 'Credit_Check', 'Data_Protection_Statement', 'Agree_Ploicy'].includes(key)) {
    ...
    if (validateForm(object)) {
      ...
      try {
        const response = await axios.post(apiUrl, JSON.stringify({ data: object }), {
          headers: {
        ...
        if (response.status === 200) {
          ...
          await submitAdditionalData(object, FORM_ID, 'professional-body-memberships');
  ...
  const submitAdditionalData = async (formData, formId, endpoint) => {
    ...
    if (additionalData) {
      await axios.post(URL.BASE_URL + `/api/${endpoint}`, {
        data: {
          ...additionalData,
          appliedJob: formId
        }
              ...
              <form className="row g-3" onSubmit={handleSubmit}>
                ...
                <div className="col-sm-6">
                  ...
                  >
                    <input
                      ...
                      style={{ border: '1px solid' }}
                    ></input>
                    <label htmlFor="Insurance_No">National Insurance Number</label>
                ...
                <div className="col-sm-6">
                  ...
                  >
                    ...
                    <label htmlFor="Emergency_Contact_No">
                      Emergency Contact Number (With Country Code - +44712345678)
                    </label>
                ...
                <div className="col-sm-3">
                  <div className="form-check">
                    ...
                    />
                    <label className="form-check-label" htmlFor="Driving_License">
                      Driving License
                    </label>
                  </div>
                </div>
                ...
                <h6
                      ...
                      >
                        ...
                        <p>In line with Home Office guidance on the prevention of illegal working, we will need to verify and take a copy of your original ID documentation of your right to work in the UK.</p>
                      </h6>
                ...
                <div className="col-sm-3">
                  <div className="form-check">
                    ...
                    />
                    <label className="form-check-label" htmlFor="Free_to_Takeup_Employment">
                ...
                <div className="col-sm-6">
                  ...
                  >
                    <input
                      ...
                      style={{ border: '1px solid' }}
                    ></input>
                    <label htmlFor="Current_Emp_Status">Current Employment Status</label>
                    ...
                    <div className="col-sm-6">
                      ...
                      >
                        <input
                          ...
                          style={{ border: '1px solid' }}
                        ></input>
                        <label htmlFor="Preferred_Work_Locations">Preferred Locations</label>
                ...
                <div className="col-sm-6">
                      ...
                      >
                        <input
                          ...
                          style={{ border: '1px solid' }}
                        ></input>
                        <label htmlFor="Part_Time_Hour">Time Preferred for Part Time</label>
                    ...
                    <div className="col-sm-6">
                      ...
                      >
                        <input
                          ...
                          style={{ border: '1px solid' }}
                        ></input>
                        <label htmlFor="Hourly_Rate">Annual Salary / Hourly Rate Expected</label>
                    ...
                    <div className="col-sm-4">
                      ...
                      >
                        <input
                          ...
                          style={{ border: '1px solid' }}
                        ></input>
                        <label htmlFor="Membership_level_and_No">Membership Level and Number </label>
                ...
                <div className="col-sm-3">
                  <div className="form-check">
                    ...
                    />
                    <label className="form-check-label" htmlFor="Crimincal_Conviction">
                    Criminal Convictions?
                    </label>
                  </div>
                </div>
                ...
                <h6
                  ...
                  >
                    <input
                      ...
                      style={{ border: '1px solid' }}
                    ></input>
                    <label htmlFor="Convicition_Description">Convicition Description</label>
                ...
                <h1
                      ...
                      <h6
                        ...
                        style={{ fontFamily: 'Alatsi' }}
                      >
                        Do you have any health issues or a relevant disability which may make it difficult for you to carry out functions which are essential for the role you seek??
                       </h6>
                ...
                <h6
                        ...
                        style={{ fontFamily: 'Alatsi' }}
                      >
                        If Yes, Please Specify. Also, If you have a disability, what are your needs in terms of reasonable adjustments in order to access this recruitment service and to attend interview, or to take aptitude tests etc.?  Please specify:
                     </h6>
                  ...
                  >
                    <input
                      ...
                      style={{ border: '1px solid' }}
                    ></input>
                    <label htmlFor="Name_of_Health_Issue">Health Issues / Disability</label>
                ...
                <div className="col-sm-6">
                  ...
                  >
                    <input
                      ...
                      style={{ border: '1px solid' }}
                    ></input>
                    <label htmlFor="Required_Adjustment">Reasonable Adjustments Required</label>
                ...
                <h1
                      ...
                      <h6
                        ...
                        style={{ fontFamily: 'Alatsi' }}
                      >
                       Clients may, in certain circumstances, request a credit check be obtained in addition to your work references. In such cases, you will be made aware that such a check is required. Should such a check be undertaken, please indicate your acceptance by ticking the checkbox here. </h6>
                ...
                <h1
                  ...
                  <div className="form-check">
                    ...
                    />
                    <label className="form-check-label" htmlFor="Consent_to_Contact">
                    Consent to Contact
                    </label>
                  </div>
                </div>
...
In exceptional circumstances, I give permission for my CV/details to be submitted to client(s) without my prior consent for vacancies that meet my requirements as outlined during my initial contact with Satchi Recruitment UK Limited. I understand that, should this occur, Satchi Recruitment UK Ltd will brief me at their earliest opportunity.
                ...
                <div className="col-sm-3">
                  <div className="form-check">
                    ...
                    />
                    <label className="form-check-label" htmlFor="Data_Protection_Statement">
                ...
                <h6
                        ...
                        style={{ fontFamily: 'Alatsi' }}
                      >
                        Please provide your consents below(If any)</h6>
                  ...
                  <h1
                      ...
                      >
                        ...
                        <p>I hereby confirm that the information provided in this application is correct. I furthermore understand that if I have made any false claims or have failed to declare information which is discovered at a later date or after appointment, any assignment I am working on may be terminated immediately.</p>
                      </h6>
                ...
                <div className="col-sm-6">
                  ...
                  <div className="form">
                    ...
                    {formErrors.Signature_Image && (
                      <div className="error-message">{formErrors.Signature_Image}</div>
                    )}
                  </div>
