    ...
    <>
      ...
      <div className="container-fluid page-header py-5 mb-5 wow fadeIn" data-wow-delay="0.1s">
        <div className="container text-center py-5">
            <h1 className="display-2 text-white py-3" style={{marginTop:'25px',fontFamily:'Alatsi'}}>CONTACT US</h1>
        </div>
    </div>
              ...
              <span className="text-center" style={{fontFamily:'Alatsi',fontSize:'25px',fontWeight:'300'}}>Phone : +44 02037 325 1388 | +44 07596 519 6045</span>
                        ...
                        <div className="col-sm-6">
                            <div className="form-floating">
                                <input type="text" className="form-control" id="name" name="Name" placeholder="Your Name" style={{ border: '1px solid'}}></input>
                                <label for="name">Your Name</label>
                            </div>
                        </div>
                        <div className="col-sm-6">
                            <div className="form-floating">
                                <input type="text" className="form-control" id="company" name="CompanyName" placeholder="Company Name" style={{ border: '1px solid'}}></input>
                                <label for="company">Company Name</label>
                            </div>
                        </div>
                        <div className="col-sm-6">
                            <div className="form-floating">
                                <input type="email" className="form-control" id="mail" name="Email" placeholder="Your Email" style={{ border: '1px solid'}}></input>
                                <label for="mail">Your Email</label>
                            </div>
                        </div>
                        <div className="col-sm-6">
                            <div className="form-floating">
                                <input type="tel" className="form-control" id="mobile" name="MobileNo" placeholder="Telephone" style={{ border: '1px solid'}}></input>
