...
function Jobpost() {
  ...
  return (
    <>
     <div className="container search-container-header py-3 mb-3" style={{borderRadius:'25px'}}>
        <form>
                ...
                <div className="col-md-10">
                  ...
                  <div className="d-flex flex-wrap mb-3">
                    <p
                      ...
                      style={{marginLeft:'10px',fontSize:'17px',marginTop:'05px',background:'#ebff9d',width:'100px',textAlign:'center',height:'40px'}}
                    >
                    ...
                    <p
                      ...
                      style={{marginLeft:'10px',fontSize:'17px',marginTop:'05px',background:'#ffb0b0',width:'100px',textAlign:'center',height:'40px'}}
                    >
            ...
            <div className="container py-2">
              <div className="row">
                <div className="col-lg-8">
                  ...
                  <p
                    className="text-black"
                    style={{ fontSize: 18, fontWeight: 400, lineHeight: "1.5",fontFamily:'Poppins' }}
                  >
...
<div className="col-12 text-center mt-4 mb-4">
      <a href="/vacancies" className="btn btn-dark btn-lg rounded-pill" style={{background:'#111727'}}>
        View More
      </a>
    </div>
    </>
